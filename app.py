...
def solve_equation():
    ...
    result = solve_equation_with_sympy(equation)  
    return render_template('CubicEquation.html', result=result)

@app.route('/CubicEquation')
def CubicEquation():
    return render_template('CubicEquation.html')
